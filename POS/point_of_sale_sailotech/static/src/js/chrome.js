odoo.define('point_of_sale_sailotech.chrome', function (require) {
"use strict";
...
var OrderSelectorWidget = PosBaseWidget.extend({
    ...
    deleteorder_click_handler: function(event, $el) {
        ...
        /*this.$('.neworder-button').removeClass('oe_hidden');*/
         this.$('.neworder-button').addClass('oe_hidden');{
        };
        /*this.$('.deleteorder-button').removeClass('oe_hidden');*/
