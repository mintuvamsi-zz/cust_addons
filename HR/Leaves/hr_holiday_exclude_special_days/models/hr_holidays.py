...
class HRHolidays(models.Model):
    ...
    def _onchange_date_from(self):
        ...
        date_from_user_tz = self.date_from
        date_to_user_tz = self.date_to
        ...
        if (date_from_user_tz and date_to_user_tz) \
            ...
            num_days_raw = self._get_number_of_days(date_from_user_tz, date_to_user_tz, self.employee_id.id)
