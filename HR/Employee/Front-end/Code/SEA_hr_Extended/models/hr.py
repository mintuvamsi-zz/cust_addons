...
class Sea_Emp_Extended(models.Model):
    _inherit = "hr.employee"

    doj = fields.Date(string="Date Of Joining",track_visibility='onchange')
    dod = fields.Date(string="Date Of Change In Designation",track_visibility='onchange')
    grade = fields.Char(string="Grade",track_visibility='onchange')
    level = fields.Char(string="Level",track_visibility='onchange')
    emp_id = fields.Char(string="Employee ID",track_visibility='onchange')
    pancard_no = fields.Char(string="Pan Card No")
    blood_group = fields.Selection([
        ...
        ('b-ve', 'B -ve'),
        ('ab+ve', 'AB +ve'),
        ('ab-ve', 'AB -ve'),   ],string="Blood Group",track_visibility='onchange')
